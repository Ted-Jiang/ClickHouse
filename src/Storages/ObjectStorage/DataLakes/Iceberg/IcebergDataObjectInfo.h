...
struct IcebergDataObjectInfo : public RelativePathWithMetadata, std::enable_shared_from_this<IcebergDataObjectInfo>
{
    ...
    explicit IcebergDataObjectInfo(Iceberg::ManifestFileEntryPtr data_manifest_file_entry_);

    explicit IcebergDataObjectInfo(String path);
    ...
    std::vector<Iceberg::ManifestFileEntryPtr> equality_deletes_objects;
