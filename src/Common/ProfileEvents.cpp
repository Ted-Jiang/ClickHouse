...
#define APPLY_FOR_BUILTIN_EVENTS(M) \
    ...
    M(IcebergMetadataFilesContentCacheHits, "Number of times iceberg metadata files content have been found in the cache.", ValueType::Number) \
    ...
    M(IcebergMetadataFilesContentCacheMisses, "Number of times iceberg metadata files contents have not been found in the iceberg metadata cache and had to be read from (remote) disk.", ValueType::Number) \
